...
import { Building, LogOut, ArrowRight } from "lucide-react-native";
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Détails de l’immeubles</Text>
        <TouchableOpacity 
      ...
      <View style={styles.banner}>
        ...
        <Text style={styles.bannerText}>
          Sélectionnez votre immeuble dans la liste
        </Text>
      </View>
      ...
      <View style={styles.selectorContainer}>
        <TextInput
          ...
          onPress={() => router.push("../display_building")}
        />
        <Building size={24} color="#64748b" style={styles.buildingIcon} />
      </View>

      <Text style={styles.helpText}>
        Si votre immeuble n’est pas dans la liste, veuillez l’enregistrer.
      </Text>

      <View style={styles.card}>
        <Text style={styles.cardTitle}>
          Votre immeuble n’est pas encore sur Bouclier ?
        </Text>
        <Text style={styles.cardSubtitle}>
          Référencez votre immeuble et contribuez à la communauté sécurisée.
        </Text>
        <TouchableOpacity
